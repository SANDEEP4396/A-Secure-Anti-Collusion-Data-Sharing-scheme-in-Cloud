        ...
        <div id="pettabs" class="indentmenu">
            <ul>
                <li><a href="Home.jsp" rel="tab1" >Home</a></li>
                  ...
                  <li><a href="Login.jsp" rel="tab2" >Login Here</a></li>
            </ul>
        </div>
	...
	<div id="templatemo_content">
        ...
        <div class="templatemo_content_section_01">
            <div class="section_01_left" style="margin-left: 280px;">
                <form action="register" method="get" onsubmit="return checked();">
                ...
                <p style="font-family:fantasy;font-size:150%;margin-left: 31px; ">  MODE : <select name="mode" style="width: 220px; height: 30px;"><option value="User">User</option>
                    <option value="Owner">Owner</option></select></p>	
