...
<script type="text/javascript">
    ...
    <div id="templatemo_banner">
    	_
        <p><font color="white">  A Secure Anti-Collusion Data Sharing Scheme for Dynamic Groups in Cloud</font></p>
            ...
            <div class="section_01_left" style="margin-left: 20px;">
                ...
                <div style="margin-left:250px; ">
                    <form action ="gr_mem" method="get">
                        <p style="font-family: monospace">Username</p>
                        ...
                        <p></p>
                        <p ><input type="submit" value="Submit" style="height:25px;width:100px;" />     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" value="Cancel" style="height:25px;width:100px;" /></p>
